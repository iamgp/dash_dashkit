    ...
    [
        html.Div(
            [
                ...
                html.P(
                    "Laboratory assay metrics and performance indicators",
        ...
        html.Div(
            [
                ...
                ChartCard(
                    title="Weekly Pass/Fail Analysis",
                    chart=dmc.BarChart(
                        h=300,
                        data=[
                            {
